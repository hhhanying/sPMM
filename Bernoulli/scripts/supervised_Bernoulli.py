...
def accuracy_supervised_Bernoulli(trainingX, trainingY, testX, testY, T, alpha_p, beta_p, K, b, alpha, ntrace, nchain, nskip):
    ...
    # this function will return the test accuracy and the estimated parameters
...
def CV_supervised_Bernoulli(X, Y, Nfold, T, alpha_p, beta_p, K, b, alpha, ntrace, nchain, nskip):
    ...
    # This function will perform K-fold cross validation a
    # Output:
    ...
    for train_index, test_index in kf.split(X):
        tem_accuracy, tem_estimation = accuracy_supervised_Bernoulli(X[train_index], Y[train_index], X[test_index], Y[test_index], T, alpha_p, beta_p, K, b, alpha, ntrace, nchain, nskip)
